...
export const userSystemToken = mysqlTable(
  "user_system_token",
  {
    ...
    system: mysqlEnum("system", ["dataease", "superset", "taskview", "buildingai"]).notNull(),
...
export const auditLog = mysqlTable(
  "audit_log",
  {
    ...
    subsystem: mysqlEnum("subsystem", ["opencode", "dataease", "taskview", "superset", "buildingai", "platform"]),
...
export const pipelineExecutionStep = mysqlTable(
  "pipeline_execution_step",
  {
    ...
    subsystem: mysqlEnum("subsystem", ["opencode", "dataease", "taskview", "superset", "buildingai"]),
...
export const subsystemConfig = mysqlTable(
  ...
  {
    id: bigint("id", { mode: "number", unsigned: true }).autoincrement().primaryKey(),
    system: mysqlEnum("system", ["opencode", "dataease", "taskview", "superset", "buildingai"]).notNull().unique(),
